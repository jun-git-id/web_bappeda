...
class Mailer {
    protected $_ci;
    protected $email_pengirim = 'bappedapkl.kab@gmail.com'; // Isikan dengan email pengirim
    protected $nama_pengirim = 'kamaludin muhamad'; // Isikan dengan nama pengirim
    protected $password = 'bappeda_123'; // Isikan dengan password email pengirim
