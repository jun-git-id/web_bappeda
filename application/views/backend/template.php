...
<html lang="en">
    <head>
        ...
        <!--<link rel="stylesheet" media="screen, print" href="<?=base_url('assets/back/')?>css/your_styles.css">-->
    </head>
    <body class="mod-bg-1 ">
                ...
                <aside class="page-sidebar">
                    <div class="page-logo">
                        <a href="#" class="page-logo-link press-scale-down d-flex align-items-center position-relative" data-toggle="modal" data-target="#modal-shortcut">
                            <img src="<?=base_url('assets/back/')?>img/logo.png" alt="SmartAdmin WebApp" aria-roledescription="logo">
                    ...
                    <nav id="js-primary-nav" class="primary-nav" role="navigation">
                        ...
                        <div class="info-card">
                            <img src="<?=base_url('assets/back/')?>img/demo/avatars/avatar-admin.png" class="profile-image rounded-circle" alt="Dr. Codex Lantern">
                            ...
                            <img src="<?=base_url('assets/back/')?>img/card-backgrounds/cover-2-lg.png" class="cover" alt="cover">
                                            ...
                                            <div class="custom-scroll h-100">
                                                <ul class="notification">
                                                    ...
                                                    <li>
                                                        <a href="#" class="d-flex align-items-center">
                                                            <span class="status status-success mr-2">
                                                                <!-- <img src="<?=base_url('assets/back/')?>img/demo/avatars/avatar-m.png" data-src="<?=base_url('assets/back/')?>img/demo/avatars/avatar-h.png" class="profile-image rounded-circle" alt="Sarah McBrook" /> -->
                                        ...
                                        <div class="tab-pane" id="tab-feeds" role="tabpanel">
                                            <div class="custom-scroll h-100">
                                                <ul class="notification">
                                                    ...
                                                    <li>
                                                        <div class="d-flex align-items-center show-child-on-hover">
                                                            <!--<img src="<?=base_url('assets/back/')?>img/demo/avatars/avatar-m.png" data-src="<?=base_url('assets/back/')?>img/demo/avatars/avatar-k.png" class="profile-image rounded-circle" alt="k" />-->
                                                            <div class="d-flex flex-column flex-1">
                                                                <span class="name">
                                                    ...
                                                    <li>
                                                        <div class="d-flex align-items-center show-child-on-hover">
                                                            <!--<img src="<?=base_url('assets/back/')?>img/demo/avatars/avatar-m.png" data-src="<?=base_url('assets/back/')?>img/demo/avatars/avatar-e.png" class="profile-image-sm rounded-circle align-self-start mt-1" alt="k" />-->
                                                            <div class="d-flex flex-column flex-1">
                                                    ...
                                                    <li>
                                                        <div class="d-flex align-items-center show-child-on-hover">
                                                            <!--<img src="<?=base_url('assets/back/')?>img/demo/avatars/avatar-m.png" data-src="<?=base_url('assets/back/')?>img/demo/avatars/avatar-h.png" class="profile-image rounded-circle align-self-start mt-1" alt="k" />-->
                                                            <div class="d-flex flex-column flex-1">
                                                                <div class="name mb-2">
                                ...
                                <div class="dropdown-menu dropdown-menu-animated dropdown-lg">
                                    <div class="dropdown-header bg-trans-gradient d-flex flex-row py-4 rounded-top">
                                        <div class="d-flex flex-row align-items-center mt-1 mb-1 color-white">
                                            <span class="mr-2">
                                                <img src="<?=base_url('assets/back/')?>img/demo/avatars/avatar-admin.png" class="rounded-circle profile-image" alt="Dr. Codex Lantern">
                                            </span>
                                            <div class="info-card-text">
