    ...
    <div class="row">
        <div class="col-xl-12">
            ...
            <div id="panel-1" class="panel d-none">
                <div class="panel-hdr">
                    <h2>
                        <i class="far fa-plus-hexagon"></i> Ubah <span class="fw-300"><i>Menu</i></span>
                    </h2>
                </div>
                <div class="panel-container show">
                    <div class="panel-content">
                        <?php foreach ($data_menu as $dt){ ?>
                        <form id="edit-berita" method="post" action="<?=base_url('admin/profil/update')?>" enctype="multipart/form-data">
                            <input type="hidden" name="id" id="id" value="<?= $dt['id']; ?>">
                            <div class="form-group">
                                <label class="form-label">Nama Menu</label>
                                <input type="text" class="form-control" name="nama_menu" id="nama_menu" placeholder="Nama Menu" value="<?= $dt['nama_menu']; ?>">
                            </div>
                            <div class="form-group">
                                <label class="form-label">Isi</label>
                                <textarea class="js-readmore form-control" name="isi" id="isi" required=""><?= $dt['isi']; ?></textarea>
                            </div>
                            <div class="form-group">
                                <label class="form-label">Nama Page</label>
                                <input type="text" class="form-control" name="page" id="page" placeholder="Nama Page" value="<?= $dt['page']; ?>">
                            </div>
                            <hr>
