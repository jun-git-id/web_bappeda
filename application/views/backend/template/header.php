                ...
                <aside class="page-sidebar">
                    <div class="page-logo">
                        <a href="#" class="page-logo-link press-scale-down d-flex align-items-center position-relative" data-toggle="modal" data-target="#modal-shortcut">
                            <img src="<?=base_url('assets/backend/')?>img/icon.png" alt="SmartAdmin WebApp" aria-roledescription="logo" style="width: 25%">
                    ...
                    <nav id="js-primary-nav" class="primary-nav" role="navigation">
                        ...
                        <div class="info-card">
                            <img src="<?=base_url('assets/backend/')?>img/icon.png" class="profile-image"  style="width: 30%">
