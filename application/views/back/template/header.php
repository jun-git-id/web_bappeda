...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" media="screen, print" href="<?=base_url('assets/back/')?>css/datagrid/datatables/datatables.bundle.css">
        <link href="<?=base_url('assets/back/')?>/libs/sweetalert/sweetalert.css" rel="stylesheet" type="text/css" />
        <link rel="stylesheet" media="screen, print" href="<?=base_url('assets/back/')?>css/formplugins/summernote/summernote.css">
        <link rel="stylesheet" media="screen, print" href="<?=base_url('assets/back/')?>css/formplugins/select2/select2.bundle.css">
        <style type="text/css">
                ...
                <aside class="page-sidebar">
                    <div class="page-logo">
                        <a href="#" class="page-logo-link press-scale-down d-flex align-items-center position-relative" data-toggle="modal" data-target="#modal-shortcut">
                            <img src="<?=base_url('assets/back/')?>img/icon.png" alt="SmartAdmin WebApp" aria-roledescription="logo" style="width: 25%">
                            <span class="page-logo-text mr-1">Bappeda WebApp</span>
                    ...
                    <nav id="js-primary-nav" class="primary-nav" role="navigation">
                        ...
                        <div class="info-card">
                            <img src="<?=base_url('assets/back/')?>img/icon.png" class="profile-image"  style="width: 30%">
                        ...
                        <div class="ml-auto d-flex">
                            ...
                            <div>
                                <a href="#" data-toggle="dropdown" title="drlantern@gotbootstrap.com" class="header-icon d-flex align-items-center justify-content-center ml-2">
                                    <img src="<?=base_url('assets/back/img/logo_pekalongan.png')?>" class="profile-image" alt="Dr. Codex Lantern">
