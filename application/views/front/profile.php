<div class="page-content">
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-6 text-center text-lg-left pr-md-4">
						<img src="<?=base_url('assets/front/images')?>/content/about-01.jpg" class="w-100" alt="">
						<div class="row mt-3">
							<div class="col-6">
								<img src="<?=base_url('assets/front/images')?>/content/about-03.jpg" class="w-100" alt="">
							</div>
							<div class="col-6">
								<img src="<?=base_url('assets/front/images')?>/content/about-04.jpg" class="w-100" alt="">
							</div>
						</div>
					</div>
		...
		<div class="section">
			<div class="container-fluid px-0">
				<div class="row no-gutters">
					...
					<div class="col-xl-6 banner-left bg-full" style="background-image: url(assets/front/images/content/banner-right.jpg)"></div>
				</div>
			</div>
		</div>
		<!--//section-->
		...
		<div class="section">
			<div class="container-fluid px-0">
				<div class="banner-center bg-cover" style="background-image: url(assets/front/images/content/banner-center.jpg)">
					...
					<div class="col-lg-8 mt-4 mt-lg-0">
						<div class="slider-gallery">
							<ul class="slider-gallery-main list-unstyled js-slider-gallery-main">
								<li><img src="<?=base_url('assets/front/images')?>/content/slider-gallery-00.jpg" alt=""></li>
								<li><img src="<?=base_url('assets/front/images')?>/content/slider-gallery-01.jpg" alt=""></li>
								<li><img src="<?=base_url('assets/front/images')?>/content/slider-gallery-02.jpg" alt=""></li>
								<li><img src="<?=base_url('assets/front/images')?>/content/slider-gallery-03.jpg" alt=""></li>
								<li><img src="<?=base_url('assets/front/images')?>/content/slider-gallery-04.jpg" alt=""></li>
								<li><img src="<?=base_url('assets/front/images')?>/content/slider-gallery-05.jpg" alt=""></li>
							</ul>
							<ul class="slider-gallery-thumbs list-unstyled js-slider-gallery-thumbs">
								<li><img src="<?=base_url('assets/front/images')?>/content/slider-gallery-00-sm.jpg" alt=""></li>
								<li><img src="<?=base_url('assets/front/images')?>/content/slider-gallery-01-sm.jpg" alt=""></li>
								<li><img src="<?=base_url('assets/front/images')?>/content/slider-gallery-02-sm.jpg" alt=""></li>
								<li><img src="<?=base_url('assets/front/images')?>/content/slider-gallery-03-sm.jpg" alt=""></li>
								<li><img src="<?=base_url('assets/front/images')?>/content/slider-gallery-04-sm.jpg" alt=""></li>
								<li><img src="<?=base_url('assets/front/images')?>/content/slider-gallery-05-sm.jpg" alt=""></li>
							</ul>
						</div>
					</div>
				</div>
